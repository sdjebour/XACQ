...
public class PtrCellBinaryStrlenEqConstraint extends BinaryConstraint {
	boolean negated = false;
	ACQ_CellVariable cell1;
	ACQ_CellVariable cell2;
	ACQ_Variable[] vars; // length = 2

	public PtrCellBinaryStrlenEqConstraint(ACQ_CellVariable cell1, ACQ_CellVariable cell2) {
		super("StrlenEq", cell1.getSize().id, cell2.getSize().id); // TODO : WARNING I don't know if it is good
	...
	public PtrCellBinaryStrlenEqConstraint(ACQ_CellVariable cell1, ACQ_CellVariable cell2, boolean negated) {
		this(cell1, cell2);
		if (negated) {
			this.setName("NotStrlenEq");
	...
	public String getBwConstraint() {
		...
		String c = String.format("(= %s %s)", val1_value, val2_value);
		if (!negated)
			return c;
		else
	...
	public ACQ_IConstraint getNegation() {
		return new PtrCellBinaryStrlenEqConstraint(this.cell1, this.cell2, !this.negated);
	}
	...
	public String toSmtlib() {
		String p = "(strleneq v" + this.cell1.cellid + " v" + this.cell2.cellid + ")";
		if (!negated)
			return p;
		else
			return "(not " + p + ")";
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PtrCellBinaryStrlenEqConstraint other = (PtrCellBinaryStrlenEqConstraint) obj;
