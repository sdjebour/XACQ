...
public interface ACQ_IConstraint extends Comparable<ACQ_IConstraint> {
	 ...
	 */
	public boolean checker(Bitvec[] values);

	/**
	 * <p>
	 * Returns the negation of this constraint. For instance, a constraint with "="
	 * as operator will return a constraint with the same scope but "!=" as operator
	 * </p>
	 * 
	...
	ConstraintSet toConstraintSet(ConstraintFactory cf);

	boolean isSubsumed(ACQ_IConstraint c, ConstraintFactory cf);
}
