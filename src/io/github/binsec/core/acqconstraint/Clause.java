...
public class Clause implements Iterable<Unit> {
	...
	public ACQ_Network toNetwork(ConstraintFactory cf, ACQ_Scope scope) {
		ACQ_Network netclause = new ACQ_Network(cf, scope);
		for (int i = 0; i < this.getSize(); i++) {
			netclause.add(this.get(i).getConstraint(), true);
		}
		return netclause;
