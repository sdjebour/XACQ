...
//		this.network= new ACQ_Network(network.getFactory(),this.getVars());
	...
	public ConstraintSet getSatConstr(ACQ_Query membership_query) {
		return network.getConstraints().getSatConstr(membership_query);
		
	}

	public ACQ_IConstraint get_Constraint(int checked) {
		return this.getConstraints().get_Constraint(checked);
