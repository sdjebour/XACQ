...
public class KappaIterator implements Iterator<ACQ_IConstraint> {
	...
	public KappaIterator(ACQ_BitwuzlaSolver constrSolver, ArchType archtype, ACQ_CellVariable[] vars, ACQ_Bias bias,
