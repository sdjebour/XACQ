...
(declare-datatype IntCell32 ((tup (ref (OptBitVec)) (value (_ BitVec 32)))))
(declare-datatype IntCell16 ((tup (ref (OptBitVec)) (value (_ BitVec 16)))))
(declare-datatype IntCell8 ((tup (ref (OptBitVec)) (value (_ BitVec 8)))))
(declare-datatype IntCellBool ((tup (ref (OptBitVec)) (value (_ BitVec 8)))))
...
(define-fun strleneq ((x PtrCell) (y PtrCell)) (Bool) (= (strlen x) (strlen y)))
(define-fun strlenlt ((x PtrCell) (y PtrCell)) (Bool) (bvult (strlen x) (strlen y)))
(define-fun strlengt ((x PtrCell) (y PtrCell)) (Bool) (bvugt (strlen x) (strlen y)))
...
(define-fun eq ((x IntCell32) (y (_ BitVec 32))) (Bool) (= (value x) y))
(define-fun eq ((x IntCell32) (y IntCell32)) (Bool) (= (value x) (value y)))

(define-fun eq ((x IntCell16) (y (_ BitVec 16))) (Bool) (= (value x) y))
(define-fun eq ((x IntCell16) (y IntCell16)) (Bool) (= (value x) (value y)))

(define-fun eq ((x IntCell8) (y (_ BitVec 8))) (Bool) (= (value x) y))
(define-fun eq ((x IntCell8) (y IntCell8)) (Bool) (= (value x) (value y)))

(define-fun eq ((x IntCellBool) (y (_ BitVec 8))) (Bool) (= (value x) y))
(define-fun eq ((x IntCellBool) (y IntCellBool)) (Bool) (= (value x) (value y)))


(define-fun sgt ((x IntCell32) (y (_ BitVec 32))) (Bool) (bvsgt (value x) y))
(define-fun sgt ((x IntCell8) (y (_ BitVec 8))) (Bool) (bvsgt (value x) y))

(define-fun ugt ((x IntCell32) (y (_ BitVec 32))) (Bool) (bvugt (value x) y))
(define-fun ugt ((x IntCell16) (y (_ BitVec 16))) (Bool) (bvugt (value x) y))
(define-fun ugt ((x IntCell8) (y (_ BitVec 8))) (Bool) (bvugt (value x) y))


(define-fun sgt ((x IntCell32) (y IntCell32)) (Bool) (bvsgt (value x) (value y)))
(define-fun ugt ((x IntCell32) (y IntCell32)) (Bool) (bvugt (value x) (value y)))

(define-fun sgt ((x IntCell16) (y IntCell16)) (Bool) (bvsgt (value x) (value y)))
(define-fun ugt ((x IntCell16) (y IntCell16)) (Bool) (bvugt (value x) (value y)))


(define-fun sgt ((x IntCell8) (y IntCell8)) (Bool) (bvsgt (value x) (value y)))
(define-fun ugt ((x IntCell8) (y IntCell8)) (Bool) (bvugt (value x) (value y)))


(define-fun slt ((x IntCell32) (y (_ BitVec 32))) (Bool) (bvslt (value x) y))
(define-fun slt ((x IntCell16) (y (_ BitVec 16))) (Bool) (bvslt (value x) y))
(define-fun slt ((x IntCell8) (y (_ BitVec 8))) (Bool) (bvslt (value x) y))

(define-fun ult ((x IntCell32) (y (_ BitVec 32))) (Bool) (bvult (value x) y))
(define-fun ult ((x IntCell16) (y (_ BitVec 16))) (Bool) (bvult (value x) y))
(define-fun ult ((x IntCell8) (y (_ BitVec 8))) (Bool) (bvult (value x) y))


(define-fun slt ((x IntCell32) (y IntCell32)) (Bool) (bvslt (value x) (value y)))
(define-fun ult ((x IntCell32) (y IntCell32)) (Bool) (bvult (value x) (value y)))

(define-fun slt ((x IntCell16) (y IntCell16)) (Bool) (bvslt (value x) (value y)))
(define-fun ult ((x IntCell16) (y IntCell16)) (Bool) (bvult (value x) (value y)))

(define-fun slt ((x IntCell8) (y IntCell8)) (Bool) (bvslt (value x) (value y)))
(define-fun ult ((x IntCell8) (y IntCell8)) (Bool) (bvult (value x) (value y)))


(define-fun smod ((x IntCell32) (y (_ BitVec 32)) (z (_ BitVec 32))) (Bool) (= (bvsrem (value x) y) z))
(define-fun smod ((x IntCell8) (y (_ BitVec 8)) (z (_ BitVec 8))) (Bool) (= (bvsrem (value x) y) z))

(define-fun umod ((x IntCell32) (y (_ BitVec 32)) (z (_ BitVec 32))) (Bool) (= (bvurem (value x) y) z))
(define-fun umod ((x IntCell16) (y (_ BitVec 16)) (z (_ BitVec 16))) (Bool) (= (bvurem (value x) y) z))
(define-fun umod ((x IntCell8) (y (_ BitVec 8)) (z (_ BitVec 8))) (Bool) (= (bvurem (value x) y) z))

(define-fun abseq ((x IntCell32) (y IntCell32)) (Bool) (and (bvsge (value x) #x00000000) (or (= (value x) (value y)) (= (value x) (bvneg (value y))))))
(define-fun absgt ((x IntCell32) (y IntCell32)) (Bool) (or (and (bvsgt (value x) (value y)) (bvsge (value y) #x00000000)) (and (bvsgt (value x) (bvneg (value y))) (bvslt (value y) #x00000000))))
(define-fun abslt ((x IntCell32) (y IntCell32)) (Bool) (or (and (bvsgt (value y) (value x)) (bvsge (value x) #x00000000)) (and (bvsgt (value y) (bvneg (value x))) (bvslt (value x) #x00000000))))


(define-fun abseq ((x IntCell8) (y IntCell8)) (Bool) (and (bvsge (value x) #x00) (or (= (value x) (value y)) (= (value x) (bvneg (value y))))))
(define-fun absgt ((x IntCell8) (y IntCell8)) (Bool) (or (and (bvsgt (value x) (value y)) (bvsge (value y) #x00)) (and (bvsgt (value x) (bvneg (value y))) (bvslt (value y) #x00))))
(define-fun abslt ((x IntCell8) (y IntCell8)) (Bool) (or (and (bvsgt (value y) (value x)) (bvsge (value x) #x00)) (and (bvsgt (value y) (bvneg (value x))) (bvslt (value x) #x00))))


; Define the uniterpreted function sum
(declare-fun sum 
        ((Array (_ BitVec 32) (_ BitVec 32)) (_ BitVec 32) IntCell32)
        (_ BitVec 32))
...
(define-fun mul ((x (_ BitVec 32)) (y IntCell32)) (_ BitVec 32) (bvmul x (value y)))
(define-fun mul ((x (_ BitVec 16)) (y IntCell16)) (_ BitVec 16) (bvmul x (value y)))
(define-fun mul ((x (_ BitVec 8)) (y IntCell8)) (_ BitVec 8) (bvmul x (value y)))

(define-fun add ((x (_ BitVec 32)) (y (_ BitVec 32))) (_ BitVec 32) (bvadd x y))
(define-fun add ((x (_ BitVec 16)) (y (_ BitVec 16))) (_ BitVec 16) (bvadd x y))
(define-fun add ((x (_ BitVec 8)) (y (_ BitVec 8))) (_ BitVec 8) (bvadd x y))
...
"""
    ...
    for i in range(nargs):
        if types[i] == "STR":
            ...
            smtstr += "\n(declare-fun v{} () IntCell32)\n".format(i)
        elif types[i] in { "UINT8","UINT16","INT8" }:
            smtstr += "\n(declare-fun v{} () IntCell{})\n".format(i, types[i].split("INT")[1])
        elif types[i]=="BOOL":
            smtstr += "\n(declare-fun v{} () IntCellBool)\n".format(i)
        else:
            assert False
            
        
        if types[i] == "INT":
        # -100 = 0xffffff9c, 100 = 0x00000064 (32 bits)
            smtstr += "(assert (and (bvsge (value v{0}) #xffffff9c) (bvsle (value v{0}) #x00000064)))\n".format(i)
        elif types[i] == "UINT":
        # 0 to 100 (32 bits)
            smtstr += "(assert (bvule (value v{0}) #x00000064))\n".format(i)
        elif types[i] == "INT8":
        # -100 = 0x9c, 100 = 0x64 (8 bits)
            smtstr += "(assert (and (bvsge (value v{0}) #x9c) (bvsle (value v{0}) #x64)))\n".format(i)
        elif types[i] == "UINT8":
        # 0 to 100 (8 bits)
            smtstr += "(assert (bvule (value v{0}) #x64))\n".format(i)
        elif types[i] == "INT16":
        # -100 = 0xff9c, 100 = 0x0064 (16 bits)
            smtstr += "(assert (and (bvsge (value v{0}) #xff9c) (bvsle (value v{0}) #x0064)))\n".format(i)
        elif types[i] == "UINT16":
        # 0 to 100 (16 bits)
            smtstr += "(assert (bvule (value v{0}) #x0064))\n".format(i)
        ...
        if not scopes[i]:
            ...
            smtstr += "(assert (= (select mem (value (ref v{0}))) ((_ extract 7 0) (value v{0}))))\n".format(i)


    ptr_indexes = [i for i in range(nargs) if types[i] == "STR" ]
    ...
    smtstr += "(print-smt2) (check-sat)\n(exit)"

    solv = Solver()
    solv.set("timeout", 15000) # 15 s
    print("\n")
    print(smtstr)
    print("\n")
...
def parseconf(conffile):
    ...
    for line in lines:
        if line.startswith("expr") or line.startswith("precond"):
            ...
            strval = line.split(":", 1)[1].strip()
            res["types"] = [s.strip().split("_", 1)[0] for s in strval.split(",") if s.strip() != ""]
